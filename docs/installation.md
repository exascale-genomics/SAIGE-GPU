...
Currently, Step 2 is not optimized to use GPUs and can run multiple traits. 
You can also test step 2 for a single phenotype on multiple cores by running the following:
