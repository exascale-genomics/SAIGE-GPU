...
# in R
x_eur <- readRDS("/ccs/home/arodriguez/med112/task0101113/output/GIA_ANC_Run/SUBMIT/complete_step2.finishedstep1tasks.gpu.EUR.rds")
eur_phecodes <- read.csv("/ccs/home/arodriguez/med112/task0101113/output/GIA_ANC_Run/SUBMIT/EUR.counts.completed.txt", sep=" ", header=F)
...
saveRDS(x_eur_left, "/ccs/home/arodriguez/med112/task0101113/output/GIA_ANC_Run/SUBMIT/complete_step2.leftover.finishedstep1tasks.gpu.EUR.rds")
