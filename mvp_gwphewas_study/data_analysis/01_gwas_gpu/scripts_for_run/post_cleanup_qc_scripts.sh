# AFR:
cd /ccs/home/arodriguez/med112/task0101113/output/HARE_ANC_Run/SUBMIT
...
# in R
x_afr <- readRDS("/ccs/home/arodriguez/med112/task0101113/output/HARE_ANC_Run/SUBMIT/complete_step2.finishedstep1tasks.gpu.AFR.rds")
afr_phecodes <- read.csv("/ccs/home/arodriguez/med112/task0101113/output/HARE_ANC_Run/SUBMIT/AFR.counts.completed.txt", sep=" ", header=F)
...
saveRDS(x_afr_left, "/ccs/home/arodriguez/med112/task0101113/output/HARE_ANC_Run/SUBMIT/complete_step2.leftover.finishedstep1tasks.gpu.AFR.rds")
