#Rscript /ccs/home/arodriguez/med112/task0101113/batch/pre-gwas/gwPheWAS-Summit/scripts_for_run/create_parallel_submit_file.v1.r ASN > ./submit.step1.parallel.ASN.gpu.txt
